    ...
    for (const repo of repos) {
      ...
      try {
        ...
        if (blackboxApiKey && useAI) {
          ...
          // Filter 1: Profile README (matches username or known profile repo names)
          // GitHub profile READMEs can use the username or legacy usernames
          const profileRepoPatterns = [username.toLowerCase(), 'guillaume18100'];
          if (profileRepoPatterns.includes(repoName) || description.includes('config files for my github profile')) {
